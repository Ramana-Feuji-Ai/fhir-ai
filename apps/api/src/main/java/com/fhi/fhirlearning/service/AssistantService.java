 ...
 * hand it to the model as context for one plain chat completion.
 */
@Service
public class AssistantService {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            material provided below when it's relevant. If no material is provided, or the question \
            goes beyond it, answer from your own knowledge of the real FHIR R4 specification. \
    ...
    public AssistantService(TopicRepository topicRepository, PhaseRepository phaseRepository, FhirProperties props) {
    ...
    public AssistantAskResponse ask(AssistantAskRequest req) {
        ...
        String context = switch (req.contextType()) {
