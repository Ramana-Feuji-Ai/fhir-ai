    ...
    <div class="hero3d" #canvasContainer>
      ...
      <div class="hero3d-overlay">
        <div class="hero3d-content">
          ...
          <p class="lead">A structured, interactive academy from foundations through advanced labs — featuring video lessons, hands-on exercises, progress tracking, and blueprint-aligned practice for real-world implementation.</p>
          <div class="trust-row">
            <span class="trust-pill"><i>✓</i> 16 Learning Phases</span>
            <span class="trust-pill"><i>✓</i> 200+ Interactive Topics</span>
            <span class="trust-pill"><i>✓</i> Video-Enhanced Lessons</span>
            <span class="trust-pill"><i>✓</i> Hands-on Labs & Quizzes</span>
          </div>
          <div class="cta-row">
            <a class="btn primary" routerLink="/" fragment="curriculum">Explore Curriculum</a>
            <a class="btn secondary" routerLink="/phase/0">Start Phase 0 →</a>
          </div>
          <div class="stats-bar">
