      ...
      >
                ...
                @if (conversationOnLastLine() && fullscreen()) {
                  <div class="convoNextCta">
                    ...
                    <div class="convoNextBtns">
                      ...
                      <button type="button" class="convoNextBtn" (click)="onNext()">
                        {{ index() === topic.slides.length - 1 ? 'Done' : 'Next →' }}
                      </button>
                    </div>
                  </div>
                }
        ...
        <div class="scormNav">
          ...
          <div class="navBtns">
            ...
            <button type="button" class="nextBtn" (click)="onNext()">
              {{ index() === topic.slides.length - 1 ? 'Done' : 'Next →' }}
            </button>
          </div>
        </div>
...
export class SlideDeckComponent {
  ...
  private markDone(): void {
    ...
    if (this.finished || this.topic.completed) {
      return;
    }
    this.finished = true;
