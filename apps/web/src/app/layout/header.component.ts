  ...
  template: `
    <header>
      <nav class="wrap">
        ...
        @if (auth.isLoggedIn()) {
          <div class="navlinks">
            <a routerLink="/" fragment="pathway" title="Four-stage recommended order of study">Pathway</a>
            <a routerLink="/" fragment="curriculum" title="Full catalog of all learning phases">Curriculum</a>
            <a routerLink="/phase/15">Labs</a>
      ...
      @if (auth.isLoggedIn()) {
        <div id="mobile" class="mobile" [class.open]="menuOpen()">
          <a routerLink="/" fragment="pathway" title="Four-stage recommended order of study" (click)="close()">Pathway</a>
          <a routerLink="/" fragment="curriculum" title="Full catalog of all learning phases" (click)="close()">Curriculum</a>
          <a routerLink="/phase/15" (click)="close()">Labs</a>
